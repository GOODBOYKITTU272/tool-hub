...
import { getDashboardStats, mockRequests, mockTools, currentUser } from '@/lib/mockData';
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-display font-bold">Your Tools</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {mockTools.slice(0, 3).map((tool, index) => (
